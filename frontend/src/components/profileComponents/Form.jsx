              ...
              >
                ...
                >
                  ...
                  <Link to={"https://facebook.com"}>
                    <span style={{ fontSize: "8px" }} className="text-blue-400">
                      {" "}
                      Change Name
                    </span>
                  </Link>
          ...
          >
            ...
            >
              ...
              >
                ...
                {userInfo.username} for another 14 days.
        ...
        >
          ...
          >
            <div
              ...
              className="border cursor-pointer rounded-lg bg-blue-500 hover:bg-blue-600"
            >
              <Typography
                fontSize={"9px"}
                fontWeight={500}
